...
#ifndef MyG4Scintillation_h
#define MyG4Scintillation_h 1
...
class MyG4Scintillation : public G4VRestDiscreteProcess
{
 public:
  explicit MyG4Scintillation(const G4String& processName = "Scintillation",
                           G4ProcessType type          = fElectromagnetic);
  ~MyG4Scintillation();

  MyG4Scintillation(const MyG4Scintillation& right) = delete;
  MyG4Scintillation& operator=(const MyG4Scintillation& right) = delete;

  // MyG4Scintillation Process has both PostStepDoIt (for energy
  ...
  // If set, the MyG4Scintillation process expects the user to have
  ...
  // Call by the user to set the MyG4ScintillationTrackInformation
  // to scintillation photon track

  G4bool GetScintillationTrackInfo() const;
  // Return the boolean for whether or not the
  // MyG4ScintillationTrackInformation is set to the scint. photon track
...
inline G4bool MyG4Scintillation::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline G4bool MyG4Scintillation::GetFiniteRiseTime() const
{
  return fFiniteRiseTime;
}

inline G4PhysicsTable* MyG4Scintillation::GetIntegralTable1() const
{
  return fIntegralTable1;
}

inline G4PhysicsTable* MyG4Scintillation::GetIntegralTable2() const
{
  return fIntegralTable2;
}

inline G4PhysicsTable* MyG4Scintillation::GetIntegralTable3() const
{
  return fIntegralTable3;
}

inline void MyG4Scintillation::AddSaturation(G4EmSaturation* sat)
{
  fEmSaturation = sat;
}

inline void MyG4Scintillation::RemoveSaturation() { fEmSaturation = nullptr; }

inline G4EmSaturation* MyG4Scintillation::GetSaturation() const
{
  return fEmSaturation;
}

inline G4bool MyG4Scintillation::GetScintillationByParticleType() const
{
  return fScintillationByParticleType;
}

inline G4bool MyG4Scintillation::GetScintillationTrackInfo() const
{
  return fScintillationTrackInfo;
}

inline G4bool MyG4Scintillation::GetStackPhotons() const { return fStackingFlag; }

inline G4int MyG4Scintillation::GetNumPhotons() const { return fNumPhotons; }

inline G4double MyG4Scintillation::single_exp(G4double t, G4double tau2)
{
  return std::exp(-1.0 * t / tau2) / tau2;
}

inline G4double MyG4Scintillation::bi_exp(G4double t, G4double tau1,
                                        G4double tau2)
{
