...
#ifndef MyG4Cerenkov_h
#define MyG4Cerenkov_h 1
...
class MyG4Cerenkov : public G4VProcess
{
 public:
  explicit MyG4Cerenkov(const G4String& processName = "Cerenkov",
                      G4ProcessType type          = fElectromagnetic);
  ~MyG4Cerenkov();

  explicit MyG4Cerenkov(const MyG4Cerenkov& right);

  MyG4Cerenkov& operator=(const MyG4Cerenkov& right) = delete;
...
inline G4bool MyG4Cerenkov::GetTrackSecondariesFirst() const
{
  return fTrackSecondariesFirst;
}

inline G4double MyG4Cerenkov::GetMaxBetaChangePerStep() const
{
  return fMaxBetaChange;
}

inline G4int MyG4Cerenkov::GetMaxNumPhotonsPerStep() const { return fMaxPhotons; }

inline G4bool MyG4Cerenkov::GetStackPhotons() const { return fStackingFlag; }

inline G4int MyG4Cerenkov::GetNumPhotons() const { return fNumPhotons; }

inline G4PhysicsTable* MyG4Cerenkov::GetPhysicsTable() const
{
  return thePhysicsTable;
}

#endif /* MyG4Cerenkov_h */
