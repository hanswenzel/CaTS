...
class ConfigurationManager
{
 private:
  ...
  unsigned int fMaxPhotons{ 3000000 };
 ...
 public:
  ...
  {
    std::call_once(fginitInstanceFlag, ConfigurationManager::initConfigurationManager);
    return fginstance;
  }
  static void initConfigurationManager() { fginstance = new ConfigurationManager(); }
#ifdef WITH_ROOT
