...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
MyG4Scintillation::~MyG4Scintillation()
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::ProcessDescription(std::ostream& out) const
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4bool MyG4Scintillation::IsApplicable(const G4ParticleDefinition& aParticleType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::PreparePhysicsTable(const G4ParticleDefinition&) { Initialise(); }

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::Initialise()
{
  G4OpticalParameters* params = G4OpticalParameters::Instance();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::BuildPhysicsTable(const G4ParticleDefinition&)
{
  if(fIntegralTable1 != nullptr)
  {
    fIntegralTable1->clearAndDestroy();
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* MyG4Scintillation::AtRestDoIt(const G4Track& aTrack, const G4Step& aStep)
// This routine simply calls the equivalent PostStepDoIt since all the
// necessary information resides in aStep.GetTotalEnergyDeposit()
{
  return MyG4Scintillation::PostStepDoIt(aTrack, aStep);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4VParticleChange* MyG4Scintillation::PostStepDoIt(const G4Track& aTrack, const G4Step& aStep)
...
// evenly along the track segment and uniformly into 4pi.
{
  ...
  for(G4int scnt = 0; scnt < N_timeconstants; ++scnt)
  {
    ...
    if(scnt == 0)
    {
      ...
      scintType     = Fast;
      scintIntegral = (G4PhysicsFreeVector*) ((*fIntegralTable1)(materialIndex));
    }
    else if(scnt == 1)
    {
      ...
      scintType     = Medium;
      scintIntegral = (G4PhysicsFreeVector*) ((*fIntegralTable2)(materialIndex));
    }
    else if(scnt == 2)
    {
      ...
      scintType     = Slow;
      scintIntegral = (G4PhysicsFreeVector*) ((*fIntegralTable3)(materialIndex));
    }
    ...
    for(size_t i = 0; i < numPhot; ++i)
    {
      ...
      G4DynamicParticle* scintPhoton = new G4DynamicParticle(opticalphoton, photonMomentum);
      ...
      if(fScintillationTrackInfo)
        secTrack->SetUserInformation(new G4ScintillationTrackInformation(scintType));
  ...
  if(verboseLevel > 1)
  {
    G4cout << "\n Exiting from MyG4Scintillation::DoIt -- NumberOfSecondaries = "
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyG4Scintillation::GetMeanFreePath(const G4Track&, G4double, G4ForceCondition* condition)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyG4Scintillation::GetMeanLifeTime(const G4Track&, G4ForceCondition* condition)
{
  *condition = Forced;
  return DBL_MAX;
}
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyG4Scintillation::sample_time(G4double tau1, G4double tau2)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
G4double MyG4Scintillation::GetScintillationYieldByParticleType(const G4Track& aTrack,
                                                                const G4Step& aStep,
                                                                G4double& yield1, G4double& yield2,
                                                                G4double& yield3)
{
  ...
  if(!yieldVector)
  {
    ...
    ed << "\nMyG4Scintillation::PostStepDoIt(): "
    ...
    G4Exception("MyG4Scintillation::PostStepDoIt", "Scint01", FatalException, ed, comments);
  }
  ...
  {
    G4ExceptionDescription ed;
    ed << "\nMyG4Scintillation::GetScintillationYieldByParticleType(): Request\n"
    ...
    G4Exception("MyG4Scintillation::GetScintillationYieldByParticleType()", "Scint03", JustWarning,
                ed, cmt);
  ...
  G4cout << "\n--- MyG4Scintillation::GetScintillationYieldByParticleType() ---\n"
         << "--\n"
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::DumpPhysicsTable() const
{
  if(fIntegralTable1)
  {
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::SetTrackSecondariesFirst(const G4bool state)
{
  fTrackSecondariesFirst = state;
  G4OpticalParameters::Instance()->SetScintTrackSecondariesFirst(fTrackSecondariesFirst);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::SetFiniteRiseTime(const G4bool state)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::SetScintillationByParticleType(const G4bool scintType)
{
  if(fEmSaturation && scintType)
  {
    G4Exception("MyG4Scintillation::SetScintillationByParticleType", "Scint02", JustWarning,
                "Redefinition: Birks Saturation is replaced by "
                "ScintillationByParticleType!");
    RemoveSaturation();
  }
  fScintillationByParticleType = scintType;
  G4OpticalParameters::Instance()->SetScintByParticleType(fScintillationByParticleType);
}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::SetScintillationTrackInfo(const G4bool trackType)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::SetStackPhotons(const G4bool stackingFlag)
{
...
//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
void MyG4Scintillation::SetVerboseLevel(G4int verbose)
{
