...
// ********************************************************************
//
/// \file MCSteppingAction.cc
/// \brief Implementation of the CaTS::MCSteppingAction class
...
void MCSteppingAction::Print()
{
  /*
  G4cout << "===================================================" << G4endl;
  G4cout << " MCSteppingAction configuration:      " << G4endl;
  G4cout << " Kill Pi0s :                        " << fkillPi0 << G4endl;
  G4cout << " Kill etas :                        " << fkilleta << G4endl;
  G4cout << " Kill Gammas from neutron Capture:  " << fkillGammafromnCapture << G4endl;
  G4cout << "===================================================" << G4endl;
  */
}
/*
void MCSteppingAction::DefineCommands()
{
  fMessenger = new G4GenericMessenger(this, "/CaTS/MCSteppingAction/", "select particles to kill");
  ...
  auto& killGammafromnCaptureCmd =
    fMessenger->DeclareProperty("killGammafromnCapture", fkillGammafromnCapture);
  killGammafromnCaptureCmd.SetGuidance("kill GammafromnCapture (true/false)");
  killGammafromnCaptureCmd.SetStates(G4State_PreInit, G4State_Init, G4State_Idle);
  killGammafromnCaptureCmd.SetDefaultValue("false");
  fMessenger->DeclareMethod("Print", &MCSteppingAction::Print)
    .SetGuidance("Print MCSteppingAction configuration")
