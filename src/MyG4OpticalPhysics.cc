...
G4_DECLARE_PHYSCONSTR_FACTORY(MyG4OpticalPhysics);

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......
MyG4OpticalPhysics::MyG4OpticalPhysics(G4int verbose, const G4String& name)
...
{
  if(verboseLevel > 0)
    G4cout << "MyG4OpticalPhysics:: Add Optical Physics Processes" << G4endl;
